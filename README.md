...
一个命令行工具。你写好故事概念和初稿，**四个互不知晓的 AI 审稿人**各自从不同角度打分（因果逻辑、人物动能、文字质地……），系统算出总分后**自动判断哪里弱、怎么修、修到什么程度停**。修完还有"三审一裁一改"的文字终校流水线。
...
> 心理医生陈恕发现自己关于患者的诊疗记录在被不留痕迹地改写。他用临床方法论追踪，最终在病历扉页上发现：入院三年，诊断"身份替代妄想"，字迹是他自己的。
...
|---|---|---|
| **v1** | 816 | 循环叙事专用 · 基础打分 |
| **v2** | 1228 | 多题材 · 四角色盲审 · 连续性台账 |
| **v2.1** | 2420 | 通顺性终校：三审一裁一改 |
